      ...
      <main className="pt-20 px-4 space-y-6">
        ...
        <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
          <div className="p-4 space-y-4">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm text-gray-400">Last Headache</p>
                <h2 className="text-2xl font-bold text-white">2 days ago</h2>
                <p className="text-gray-400">Moderate intensity</p>
              </div>
        ...
        <div className="space-y-3">
          ...
          {[
            ...
            <Card key={i} className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
              <div className="p-4">
                <div className="flex justify-between items-start">
                  <div>
                    <div className="text-sm text-gray-400">{entry.day}</div>
                    <div className="font-medium text-white">{entry.trigger}</div>
                    <div className="text-sm text-gray-400">Duration: {entry.duration}</div>
                  </div>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm text-gray-400">Most Common Trigger</div>
              ...
              {!isPremium && (
                <>
                  <div className="flex items-center justify-between opacity-50">
                    <div>
                      <div className="text-sm text-gray-400">Pattern Analysis</div>
                  ...
                  <div className="flex items-center justify-between opacity-50">
                    <div>
                      <div className="text-sm text-gray-400">Trigger Correlation</div>
