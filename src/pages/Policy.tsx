...
export default function Policy() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <header className="fixed top-0 w-full bg-card/80 backdrop-blur-sm border-b border-border z-50">
          ...
          <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Information We Collect</AccordionTrigger>
                  ...
                  <AccordionItem value="item-2" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">How We Use Your Information</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                      <ul className="list-disc pl-6 space-y-2">
                  ...
                  <AccordionItem value="item-3" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Legal Basis for Processing</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-4" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Data Sharing and Disclosure</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-5" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Your Rights</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-6" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Data Retention</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-7" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Children's Privacy</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-8" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Changes to this Privacy Policy</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-9" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Contact Us</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
            ...
            {activePolicy === "terms" && (
              <div className="space-y-4">
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Acceptance of Terms</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-2" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">User Accounts</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-3" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Intellectual Property</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-4" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Limitation of Liability</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-5" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Termination</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-6" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Changes to Terms</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
            ...
            {activePolicy === "cookies" && (
              <div className="space-y-4">
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">What Are Cookies?</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-2" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Types of Cookies We Use</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-3" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">How We Use Cookies</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-4" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Your Choices Regarding Cookies</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
            ...
            {activePolicy === "data" && (
              <div className="space-y-4">
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Data Security Measures</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-2" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Data Retention Periods</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-3" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Data Access, Correction & Deletion</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-4" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">International Data Transfers</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
                  ...
                  <AccordionItem value="item-5" className="border-border">
                    <AccordionTrigger className="text-foreground hover:text-primary">Data Protection Officer</AccordionTrigger>
                    <AccordionContent className="text-muted-foreground">
